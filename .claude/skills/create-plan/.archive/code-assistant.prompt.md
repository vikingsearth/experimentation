...
3. Create a [.ai/state/gap_analysis.md] which analyzes where to focus for the current Iteration of the work.
...
7. Once completed, follow the Testing & Validation requirements defined in [CONTRIBUTING.md]
...
11. Update the documents with the changes made by altering the [docs/designs/architecture.md] and [docs/designs/use_cases.md] and the [.ai/state/gap_analysis.md] designs of the current system.
